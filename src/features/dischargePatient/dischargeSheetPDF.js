...
const styles = StyleSheet.create({
    page: {
        ...
        fontSize: 11, // Slightly smaller default font size
    },
    section: {
    ...
    bulletPoint: {
        ...
        marginBottom: 2, // Added to control spacing
    },
});
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                <View style={{ textAlign: 'center' }}>
                    <Image
                        src={Airavat}
                        style={{ width: 140, height: 90, margin: 'auto', marginBottom: 4 }} // Slightly smaller image
                    />
                </View>
                <View style={styles.custom_header}>
                    <View>
                ...
                <View style={{ width: '100%', borderTop: '1px solid #475467', marginTop: 6 }}></View>
                ...
                {prescription?.length > 0 && (
                    <View style={{ marginBottom: 6, marginTop: 6 }}>
                        ...
                        <View style={styles.table}>
                            ...
                            {prescription?.map((prescription, index) => (
                                <View style={styles.tableRow} key={prescription.Prescription_Id}>
                                    <Text style={[styles.tableCol, { fontSize: 11 }]}>{index + 1}</Text>
                                    <Text style={[styles.medicineNameCol, { fontSize: 11 }]}>{prescription?.medicine_name}</Text>
                                    <Text style={[styles.tableCol, { fontSize: 11 }]}>{prescription?.dosage}</Text>
                                    <Text style={[styles.tableCol, { fontSize: 11 }]}>{prescription?.medicine_type}</Text>
                                    <Text style={[styles.tableCol, { width: "12%", fontSize: 11 }]}>{prescription?.frequency}</Text>
                                    <Text style={[styles.tableCol, { fontSize: 11 }]}>{prescription?.days}</Text>
                                    <Text style={[styles.tableCol, { width: "11%", fontSize: 11 }]}>{prescription?.quantity}</Text>
                                    <Text style={[styles.remarksCol, { fontSize: 11 }]}>{prescription?.common_note}</Text>
                                </View>
                            ))}
                        </View>
                    </View>
