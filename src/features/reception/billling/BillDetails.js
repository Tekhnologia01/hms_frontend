...
//                 `${process.env.REACT_APP_API_URL}/appointment/getbBillDetails`, {
//                 params: {
...
//         if (paymentMode === "Cash") {
//             const pdfBlob = await pdf(<BillPDF billData={details} />).toBlob();
//             console.log(pdfBlob);
...
//                                         </tr>
//                                         {
//                                             details?.chargesList?.map((charge, index) => (
//                                                 <tr key={index}>
...
//                                                     <td className="text-center p-md-3 p-2">{charge?.amount}</td>
//                                                 </tr>
//                                             ))
//                                         }
//                                         <tr>
//                                             <td colSpan={3} className="text-end p-md-3 p-2" style={{ fontWeight: 500 }}>Grand Total</td>
//                                             <td className="text-center p-md-3 p-2">{details?.bill_total_amount}</td>
//                                         </tr>
//                                     </tbody> :
//                                     <tbody>
//                                         <tr>
...
//                 </Container>
//             }
//             <ViewOPDBill show={showBill} setShow={setShowBill} data={details} />
...
//                     <p>Thank You! Your Payment of Rs. {details?.bill_total_amount} has been received.</p>
//                     <CommanButton
//                         label="Ok"
//                         className="p-1 px-4 fw-semibold me-2"
//                         style={{ borderRadius: "7px", fontSize: "14px", height: "40px" }}
...
// export default BillDetails;import { useEffect, useState } from "react";
